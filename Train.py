...
def argument():
    ...
    parser.add_argument("--root_path", "-r", type = str, default= "/home/nxhai/Downloads/AI/ComputerVision/ComputerVision/Animal_classification/animals")
    parser.add_argument("--batch_size", "-b", type = int, default = 64)
    parser.add_argument("--num_workers", "-n", type = int, default = 20)
...
def img_classifier(args):
    ...
    model = get_efficient(19, "/app/checkpoints/efficientnet_b0_rwightman-3dd342df.pth")
