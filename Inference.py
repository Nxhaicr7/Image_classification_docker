...
def get_arg():
    ...
    parser.add_argument("--checkpoint", "-c", type=str, default="precheckpoint/animals/last.pt")
...
def load_model(checkpoint_path, num_classes=19, device='cpu'):
    model = get_efficient(num_classes, "/app/checkpoints/efficientnet_b0_rwightman-3dd342df.pth")
...
def inference_from_path(image_path, size=224, checkpoint_path="precheckpoint/animals/last.pt"):
